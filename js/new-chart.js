...
(function (window, $, nova) {
    ...
    novaChart.prototype = {
        ...
        init: function (options) {
            ...
            // 适配高分屏
            var pixelRatio = (window.devicePixelRatio || 1) / (this.ctx.backingStorePixelRatio || 1);
            this.ctx.setTransform(pixelRatio, 0, 0, pixelRatio, 0, 0);
            this.canvasWidth = this.$chart.width()*pixelRatio;
            this.canvasHeight = this.$chart.height()*pixelRatio;
